...
def main():
    ...
    train_dataset = datasets.ImageNet(root="~/ImageNet", split="train", transform=transform_train)
    val_dataset = datasets.ImageNet(root="~/ImageNet", split="val", transform=transform_val)
